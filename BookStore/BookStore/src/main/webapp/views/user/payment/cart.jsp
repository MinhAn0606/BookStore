<%-- 
    Document   : cart
    Created on : Oct 30, 2025, 9:35:35 PM
    Author     : Admin
--%>
                            ...
                            <div class="table-content table-responsive mb-15 border-1">
                                <table>
                                    ...
                                    <c:forEach items="${cart.getItems()}" var="item">
                                        ...
                                        <tr>
                                            <td class="product-thumbnail"><a href="#"><img src="${b.getImageUrl()}" alt="man" /></a></td>
                                            <td class="product-name"><a href="#">${b.getTitle()}</a></td>
                                            <td class="product-price"><span class="amount">${b.getPrice()}</span></td>
                                            ...
                                            <td class="product-subtotal">${b.getPrice() * item.getQuantity()}</td>
                                            <!--<td class="product-subtotal">$<fmt:formatNumber value="${b.getPrice() * item.getQuantity()}" type="number" minFractionDigits="2" maxFractionDigits="2"/></td>-->

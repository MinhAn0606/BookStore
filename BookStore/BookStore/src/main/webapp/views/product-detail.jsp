<%-- 
    ...
    Created on : Oct 26, 2025, 6:35:38 PM
    Author     : Admin
--%>
                                        ...
                                        <div class="flexslider">
                                            <ul class="slides">
                                                <li data-thumb="img/thum-2/1.jpg">
                                                    <img src="${pageContext.request.contextPath}/${bookDetail.getImageUrl()}" alt="woman" />
                                            </li>
                                    ...
                                    <div class="product-info-main">
                                        ...
                                        <div class="product-info-price">
                                            <div class="price-final">
                                                <span>$${bookDetail.getPrice()}</span>

                                            </div>
                                        </div>
                                        <div class="product-add-form">
                                            <form action="payment?action=add-product" method="POST">
                                                <input type="hidden" name="id" value="${bookDetail.getBookId()}"/>
                                                <div class="quality-button">
                                                    <input class="qty" type="number" value="1" name="stock">
                                                </div>
                            ...
                            <div class="tab-active-2 owl-carousel">
                                ...
                                <div class="product-wrapper">
                                    <div class="product-img">
                                        <a href="#">
                                            <img src="${pageContext.request.contextPath}/views/img/product/1.jpg" alt="book" class="primary" />
                                        </a>
                                ...
                                <div class="product-wrapper">
                                    <div class="product-img">
                                        <a href="#">
                                            <img src="${pageContext.request.contextPath}/views/img/product/7.jpg" alt="book" class="primary" />
                                        </a>
                                        <div class="quick-view">
                                            <a class="action-view" href="#" data-bs-target="#productModal" data-bs-toggle="modal" title="Quick View">
                                                <i class="fa fa-search-plus"></i>
                        ...
                        <div class="shop-left">
                            ...
                            <div class="banner-area mb-30">
                                <div class="banner-img-2">
                                    <a href="#"><img src="${pageContext.request.contextPath}/views/img/banner/33.jpg" alt="banner" /></a>
                                </div>
                            </div>

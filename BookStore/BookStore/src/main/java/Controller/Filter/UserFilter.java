...
//        Ktra dang nhap chua
        ...
        User user = (User) session.getAttribute(Common.CommonConst.SESSION_USERNAME);
        if (session.getAttribute(Common.CommonConst.SESSION_USERNAME) == null) {
            res.sendRedirect(req.getContextPath() + "/authen?action=login");
            return;
        } else {
//            kiem tra role cua account
